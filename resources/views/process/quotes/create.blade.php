                        ...
                        <form method="POST" action="{{route('process.quotes_tutor.store')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" class="form-control form-control-sm" name="value" id="value" style="text-align:right;" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="fecha_postulada">{!! trans('Fecha de entrega') !!}</label>
                                    <input type="date" class="form-control form-control-sm" name="fecha_postulada" id="value" value="{{$request->date_delivery}}" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="comentarios_tutor">{!! trans('Comentarios Tutor') !!}</label>
                                    <textarea name="comentarios_tutor" id="" class="form-control form-control-sm" rows="2" ></textarea>
                                </div>
                            </div>
