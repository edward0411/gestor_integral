        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header color-header">
                    <h5 class="card-title" style="font-weight: bold;">{!! trans('Editar Calificación') !!}</h5>
                </div>
                <!-- /.card-header -->
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="id_deliverable" class="form-control form-control-sm" value="{{$quality->deliverable->id}}" readonly>
                                <input type="hidden" name="id_qualificate" value="{{$quality->id}}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="date_deliverable">{!! trans('Fecha de subida de entregable') !!}</label>
                                <input type="date" name="date_deliverable" class="form-control form-control-sm" value="{{$quality->deliverable->date_delivery}}" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control form-control-sm" id="type_bond" name="type_bond" onchange="filtersQualificate()" required>
                                    ...
                                    @foreach($types as $type)
                                        <option value="{{$type->id}}" {{ $type->id == $quality->state_deliverable ? 'selected' : '' }} >{{$type->p_text}}</option> 
                                    @endforeach    
                            </select>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control form-control-sm" id="num_qualificate" name="num_qualificate" required>
                                    <option value="{{$quality->value_qualificate}}">{{$quality->points->point_value}}</option> 
