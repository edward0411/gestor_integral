        ...
        <div class="col-12">
            <div class="card ">
                <div class="card-header color-header">
                    <h5 class="card-title" style="font-weight: bold;">{!! trans('Editar trabajo') !!}</h5>
                </div>
                <!-- /.card-header -->
                ...
                <form method="POST" action="{{route('process.request.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{route('process.works.index')}}" class="btn btn-warning btn-sm float-right">{!! trans('Regresar')
                            !!}</a>
                    </div>
                    <!-- /.card-body -->
                </form>
