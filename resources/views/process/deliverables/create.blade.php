        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header color-header">
                    <h5 class="card-title" style="font-weight: bold;">{!! trans('Crear Entregable') !!}</h5>
                </div>
                <!-- /.card-header -->
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="file" name="file_deliverable" class="form-control form-control-sm" required>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="obs_deliverable" cols="30" rows="3" class="form-control form-control-sm"></textarea>
                            </div>
                        </div>
