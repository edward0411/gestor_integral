            ...
            <div class="">
                <div class="card card-outline card-warning">
                    <div class="card-header text-center ">
                        <div class="tab">
                            <button class="btn btn-warning btn-sm" onclick="openRegister(event, 'Client')" id="defaultOpen">Cliente</button>
                            <button class="btn btn-warning btn-sm" onclick="openRegister(event, 'Tutor')">Tutor</button>
                        </div>
                        ...
                        <div id="Tutor" class="tabcontent">
                            <form action="{{ route('register_tutors') }}" method="post">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <div class="input-group mb-3">
                                            <input id="u_name" type="text" class="form-control form-control-sm @error('u_name') is-invalid @enderror" name="u_name" value="{{ old('u_name') }}" required autocomplete="u_name" placeholder="Nombre Completo" autofocus>
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                                                    <span class="fas fa-user"></span>
                                                </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="input-group mb-3">
                                            <input id="u_nick_name" type="text" class="form-control form-control-sm @error('name') is-invalid @enderror" name="u_nick_name" value="{{ old('u_nick_name') }}" required autocomplete="u_nick_name" placeholder="Nick-Name">
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                                                    <span class="fas fa-user"></span>
                                                </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="input-group mb-3">
                                            <input id="u_num_doc" type="number" class="form-control form-control-sm @error('u_num_doc') is-invalid @enderror" name="u_num_doc" value="{{ old('u_num_doc') }}" required autocomplete="u_num_doc" placeholder="Número Documento">
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="input-group mb-3">
                                            <input id="email" type="email" class="form-control form-control-sm @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Correo electronico">
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                                                    <span class="fas fa-envelope"></span>
                                                </div>
