                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input id="u_name" type="text" class="form-control form-control-sm @error('name') is-invalid @enderror" name="u_name" value="{{ old('name') }}" autocomplete="name" autofocus>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input id="u_nick_name" onchange="spc();" type="text" class="form-control form-control-sm @error('u_nick_name') is-invalid @enderror" name="u_nick_name" value="{{ old('u_nick_name') }}" required autocomplete="u_nick_name">
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                                                    <span class="fas fa-user"></span>
                                                </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <select name="id_money" id="id_money" class="form-control form-control-sm" required>
                                                ...
                                                <option value="{{$coin->id}}">{{$coin->c_type_currency}} - {{$coin->c_currency}}</option>
                                                @endforeach
                                            </select>
                                            <div class="input-group-append">
                                                <div class="input-group-text">
